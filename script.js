                  ...
                  React.createElement("thead", null,
                    React.createElement("tr", { className: "bg-slate-700/50 border-b border-slate-700" },
                      ...
                      leaderboard.map(([player, data], idx) => {
                        ...
                        return (
                          React.createElement("th", { key: player, className: "px-2 py-1 text-center border-l border-slate-700 cursor-pointer", onClick: () => requestPlayerSort(player), style: { minWidth: '2rem' } },
                            React.createElement("div", { className: "text-white font-semibold text-xs whitespace-nowrap" }, player, playerSortConfig.key === player && (playerSortConfig.direction === 'ascending' ? ' \u25B2' : ' \u25BC')),
